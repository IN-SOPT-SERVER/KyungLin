...
const updateUser = async (req: Request, res: Response) => {
  ...
  if (!data) {
    return res.status(sc.BAD_REQUEST).send(success(sc.BAD_REQUEST, rm.UPDATE_USER_FAIL));
  }
...
const deleteUser = async (req: Request, res: Response) => {
  ...
  if (!data) {
    return res.status(sc.NOT_FOUND).send(success(sc.NOT_FOUND, rm.DELETE_USER_FAIL));
  }
...
const getUserById = async (req: Request, res: Response) => {
  ...
  if (!data) {
    return res.status(sc.NOT_FOUND).send(success(sc.NOT_FOUND, rm.READ_USER_FAIL));
  }
